...
5. **SmartScreen Warning:** First launch may trigger SmartScreen because the binary is unsigned—choose “More info” → “Run anyway”.
...
* **Missing libraries (Linux):** If the AppImage fails, ensure you have basic GTK libs installed (`libgtk-3-0`, `libx11-6`).
